...
$client_time = $arr['client_time'];
$client_phone = $arr['client_phone'];
$client_add = $arr['client_add'];
$client_note = $arr['client_note'];
...
if (isset($_POST['token']) && $_POST['token'] == $_SESSION['token']) {
    ...
    //构建插入的SQL语句
    $sql = "UPDATE client SET client_name='$client_name',client_pwd='$client_pwd',client_time='$client_time',client_phone='$client_phone',client_add='$client_add',client_note='$client_note' WHERE client_id=$id";

    //判断SQL语句是否执行成功
    if (mysqli_query($link, $sql)) {
        echo "<script>alert('修改成功!')</script>";   //通过js弹出窗口
        header("refresh:0;url=ren-client.php");
    }
            ...
            <form method="post" action="">
                ...
                <table width="600" bordercolor="#FFF" border="1" rules="all" align="center" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="client_pwd" value="<?php echo $client_pwd ?>"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="client_time" value="<?php echo $client_time ?>"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="client_note" value="<?php echo $client_note ?>""></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
