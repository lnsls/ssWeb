...
if (isset($_POST['token']) && $_POST['token'] == $_SESSION['token']) {
    ...
    //执行查询的SQL语句
    $sqlNmd = "SELECT * FROM supplier WHERE supplier_name = '$supplier_name'";
    ...
    if (mysqli_num_rows($result)) {
        ...
        //构建插入的SQL语句
        $sql = "INSERT INTO supplier VALUES(null,'$supplier_name','$supplier_pwd','$supplier_time','$supplier_phone','$supplier_add','$supplier_note')";

        //判断SQL语句是否执行成功
        if (mysqli_query($link, $sql)) {
            echo "<script>alert('新供应商添加成功!')</script>";   //通过js弹出窗口
            ...
            <form method="post" action="">
                ...
                <table width="600" bordercolor="#FFF" border="1" rules="all" align="center" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="supplier_pwd"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="supplier_time" value="<?php echo $time ?>"></td>
                        <td width="120" align="right">手机号：</td>
                        <td><input type="text" name="supplier_phone"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="supplier_add"></td>
                        <td width="120" align="right">备注：</td>
                        <td><input type="text" name="supplier_note"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
