...
//获取总数量
$sql = "SELECT staff_id, staff_name, SUM(out_num) AS staff_sum 
FROM top_staff_view 
...
<script type="text/javascript">
    ...
    function topstaffGo() {
        ...
        if (t1 != null && t2 != null) {
            //如果单击"确定"按钮，跳转到补货页面
            location.href = "top-staff.php?t1=" + t1 + "&t2=" + t2;
        } else {
            alert("未设置时间");
        }
    }
    ...
    <div class="right">
        ...
        <center>
            ...
            if ($totalRecords == 0) {
                ...
                ?>
                <a href="#" onClick="topstaffGo()">更换时间</a>
                <?php
                die();
            }
            ?>
            ...
            <table width="600" border="1" align="center" rules="all" cellpadding="5">
                ...
                foreach ($arrs as $arr) { ?>
                    ...
                    <tr align="center">
                        ...
                        <td><?php echo $arr['staff_id'] ?></td>
                        <td><?php echo $arr['staff_name'] ?></td>
                        <td><?php echo $arr['staff_sum'] ?></td>
            ...
            <script type="text/javascript">
                ...
                option = {
                    ...
                    xAxis: [
                        {
                            type: 'category',
                            data: [ <?php echo "'".$arrs[0]['staff_name'] . "','" . $arrs[1]['staff_name'] . "','" . $arrs[2]['staff_name'] . "','" . $arrs[3]['staff_name'] . "','" . $arrs[4]['staff_name'] . "','" . $arrs[5]['staff_name'] . "','" . $arrs[6]['staff_name'] . "','" . $arrs[7]['staff_name'] . "','" . $arrs[8]['staff_name'] . "','" . $arrs[9]['staff_name']."'" ?> ],
                            axisTick: {
                                alignWithLabel: true
                            }
                        }
                    ...
                    series: [
                        {
                            ...
                            type: 'bar',
                            barWidth: '60%',
                            data: [ <?php echo $arrs[0]['staff_sum'] . "," . $arrs[1]['staff_sum'] . "," . $arrs[2]['staff_sum'] . "," . $arrs[3]['staff_sum'] . "," . $arrs[4]['staff_sum'] . "," . $arrs[5]['staff_sum'] . "," . $arrs[6]['staff_sum'] . "," . $arrs[7]['staff_sum'] . "," . $arrs[8]['staff_sum'] . "," . $arrs[9]['staff_sum'] ?> ]
                        }
                    ]
                };
                ;
