...
//获取总数量
$sql = "SELECT * FROM water WHERE water_num < $lowNum";
...
$sql = "SELECT * FROM water LIMIT $startFrom, $onePageNum";
...
<script type="text/javascript">
    ...
    function inGo(waterid) {
        ...
        var num = prompt("请输入补货数量", "50");

        if (num != null && num.valueOf() > 0) {
            //如果单击"确定"按钮，跳转到补货页面
            location.href = "water-in-go.php?id=" + waterid + "&num=" + num;
        } else {
            alert("已取消");
        }
    ...
    <div class="right">
        ...
        <center>
            ...
            <div style="text-align:center; padding-bottom: 10px;">
                ...
                共找到 <font color=red><?php echo $totalRecords ?></font> 条低库存的记录 ·
            ...
            //根据搜索结果显示数据
            if ($totalRecords == 0) {
                echo "<br><br><br> <font color=red> 太棒啦！当前库存充足，无低库存商品 o_O </font> <br><br><br>";
                die();
            }
            ?>
            ...
            <table width="1050" border="1" align="center" rules="all" cellpadding="5">
                ...
                foreach ($arrs as $arr) { ?>
                    ...
                    <tr align="center">
                        ...
                        <td bgcolor='#FDBBBB'><?php echo $arr['water_num'] ?></td>
                        <td>
                            <?php
                        ...
                        <td>
                            <a href="#" onClick="inGo(<?php echo $arr['water_id'] ?>)">补货</a>
                        </td>
            ...
            //第一页
            echo "<a href='water-auto.php?page=1'>" . '第一页' . "</a> ";

            //循环输出中间的页
            for ($i = 1; $i <= $totalPages; $i++) {
                echo "<a href='water-auto.php?page=" . $i . "'> &nbsp;" . $i . "&nbsp; </a> ";
            };

            //最后一页
            echo "<a href='water-auto.php?page=$totalPages'>" . '最后一页' . "</a> ";
