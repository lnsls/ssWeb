...
if (isset($_POST['token']) && $_POST['token'] == $_SESSION['token']) {
    ...
    if (mysqli_num_rows($result)) {
        ...
        //构建插入的SQL语句
        $sql = "INSERT INTO client VALUES(null,'$client_name','$client_pwd','$client_time','$client_phone','$client_add','$client_note')";

        //判断SQL语句是否执行成功
        if (mysqli_query($link, $sql)) {
            echo "<script>alert('新客户添加成功!')</script>";   //通过js弹出窗口
            ...
            <form method="post" action="">
                ...
                <table width="600" bordercolor="#FFF" border="1" rules="all" align="center" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="client_pwd"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="client_time" value="<?php echo $time ?>"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="client_add"></td>
                        <td width="120" align="right">备注：</td>
                        <td><input type="text" name="client_note"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
