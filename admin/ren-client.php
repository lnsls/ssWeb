...
<script type="text/javascript">
    ...
    //定义一个JS的提示函数
    function delClientGo(id) {

        if (window.confirm("确定要删除吗？")) {
            //跳到页面
            location.href = "ren-client-del.php?id=" + id;
        }
    }
    ...
    <div class="right">
        ...
        <center>
            ...
            <div style="text-align:center; padding-bottom: 10px;">
                ...
                <a href="ren-client-new.php">新增</a>
            ...
            //根据搜索结果显示数据
            if ($totalRecords == 0) {
                echo "<br><br><br> <font color=red> 一个客户都没有呢 >_< </font> <br><br><br>";
                die();
            }
            ?>
            ...
            <table width="1050" border="1" align="center" rules="all" cellpadding="5">
                ...
                foreach ($arrs as $arr) { ?>
                    ...
                    <tr align="center">
                        ...
                        <td><?php echo $arr['client_pwd'] ?></td>
                        <td><?php echo $arr['client_time'] ?></td>
                        <td><?php echo $arr['client_phone'] ?></td>
                        <td><?php echo $arr['client_add'] ?></td>
                        <td>
                            <?php
                            if (trim($arr['client_note']) == null) {
                                echo 无;
                            } else {
                                echo $arr['client_note'];
                            } ?>
                        </td>
                        <td>
                            <a href="ren-client-edit.php?id=<?php echo $arr['client_id'] ?>">修改</a> |
                            <a href="#" onClick="delClientGo(<?php echo $arr['client_id'] ?>)">删除</a>
                        </td>
                    </tr>
            ...
            //第一页
            echo "<a href='ren-client.php?page=1'>" . '第一页' . "</a> ";

            //循环输出中间的页
            for ($i = 1; $i <= $totalPages; $i++) {
                echo "<a href='ren-client.php?page=" . $i . "'> &nbsp;" . $i . "&nbsp; </a> ";
            };

            //最后一页
            echo "<a href='ren-client.php?page=$totalPages'>" . '最后一页' . "</a> ";
