...
//获取总数量
$sql = "SELECT * FROM out_ WHERE out_good='1' ORDER BY out_id DESC";
...
<script type="text/javascript">
    ...
    //定义一个JS的提示函数
    function outGoodGo(id) {

        if (window.confirm("确定关闭？")) {

            //如果单击"确定"按钮，跳转到上架页面
            location.href = "out-good-close.php?id=" + id;
        }
...
<div class="con">
    ...
    <div class="right">
        ...
        <center>
            ...
            //根据搜索结果显示数据
            if ($totalRecords == 0) {
                echo "<br><br><br> <font color=red> 没有正在生效的订单呢 >_< </font> <br><br><br>";
                die();
            }
            ?>
            ...
            <table width="1050" border="1" align="center" rules="all" cellpadding="5">
                ...
                foreach ($arrs as $arr) { ?>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <a href="#" onClick="outGoodGo(<?php echo $arr['out_id'] ?>)">关闭</a>
                        </td>
            ...
            //第一页
            echo "<a href='out-good.php?page=1'>" . '第一页' . "</a> ";

            //循环输出中间的页
            for ($i = 1; $i <= $totalPages; $i++) {
                echo "<a href='out-good.php?page=" . $i . "'> &nbsp;" . $i . "&nbsp; </a> ";
            };

            //最后一页
            echo "<a href='out-good.php?page=$totalPages'>" . '最后一页' . "</a> ";
