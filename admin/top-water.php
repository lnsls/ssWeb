...
//获取总数量
$sql = "SELECT water_id, water_name, SUM(out_num) AS water_sum 
FROM top_water_view 
...
<script type="text/javascript">
    ...
    function topwaterGo() {
        ...
        if (t1 != null && t2 != null) {
            //如果单击"确定"按钮，跳转到补货页面
            location.href = "top-water.php?t1=" + t1 + "&t2=" + t2;
        } else {
            alert("未设置时间");
        }
    }
    ...
    <div class="right">
        ...
        <center>
            ...
            if ($totalRecords == 0) {
                ...
                ?>
                <a href="#" onClick="topwaterGo()">更换时间</a>
                <?php
                die();
            }
            ?>
            ...
            <script type="text/javascript">
                ...
                option = {
                    ...
                    xAxis: [
                        {
                            type: 'category',
                            data: [ <?php echo "'".$arrs[0]['water_name'] . "','" . $arrs[1]['water_name'] . "','" . $arrs[2]['water_name'] . "','" . $arrs[3]['water_name'] . "','" . $arrs[4]['water_name'] . "','" . $arrs[5]['water_name'] . "','" . $arrs[6]['water_name'] . "','" . $arrs[7]['water_name'] . "','" . $arrs[8]['water_name'] . "','" . $arrs[9]['water_name']."'" ?> ],
                            axisTick: {
                                alignWithLabel: true
                            }
                        }
                    ...
                    series: [
                        {
                            ...
                            type: 'bar',
                            barWidth: '60%',
                            data: [ <?php echo $arrs[0]['water_sum'] . "," . $arrs[1]['water_sum'] . "," . $arrs[2]['water_sum'] . "," . $arrs[3]['water_sum'] . "," . $arrs[4]['water_sum'] . "," . $arrs[5]['water_sum'] . "," . $arrs[6]['water_sum'] . "," . $arrs[7]['water_sum'] . "," . $arrs[8]['water_sum'] . "," . $arrs[9]['water_sum'] ?> ]
                        }
                    ]
                };
                ;
