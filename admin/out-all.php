...
//获取总数量
$sql = "SELECT * FROM out_ ORDER BY out_id DESC";
...
<div class="con">
    ...
    <div class="right">
        ...
        <center>
            ...
            //根据搜索结果显示数据
            if ($totalRecords == 0) {
                echo "<br><br><br> <font color=red> 一条订单都没有呢 >_< </font> <br><br><br>";
                die();
            }
            ?>
            ...
            //第一页
            echo "<a href='out-all.php?page=1'>" . '第一页' . "</a> ";

            //循环输出中间的页
            for ($i = 1; $i <= $totalPages; $i++) {
                echo "<a href='out-all.php?page=" . $i . "'> &nbsp;" . $i . "&nbsp; </a> ";
            };

            //最后一页
            echo "<a href='out-all.php?page=$totalPages'>" . '最后一页' . "</a> ";
