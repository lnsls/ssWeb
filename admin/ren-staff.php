...
<script type="text/javascript">
    ...
    //定义一个JS的提示函数
    function delstaffGo(id) {

        if (window.confirm("确定要删除吗？")) {
            //跳到页面
            location.href = "ren-staff-del.php?id=" + id;
        }
    }
    ...
    <div class="right">
        ...
        <center>
            ...
            <div style="text-align:center; padding-bottom: 10px;">
                ...
                <a href="ren-staff-new.php?id=<?php echo $arr['staff_id'] ?>">新增</a>
            ...
            <table width="1050" border="1" align="center" rules="all" cellpadding="5">
                ...
                foreach ($arrs as $arr) { ?>
                    ...
                    <tr align="center">
                        ...
                        <td><?php echo $arr['staff_pwd'] ?></td>
                        <td><?php echo $arr['staff_time'] ?></td>
                        <td><?php echo $arr['staff_phone'] ?></td>
                        <td><?php echo $arr['staff_add'] ?></td>
                        <td>
                            <?php
                            if (trim($arr['staff_note']) == null) {
                                echo 无;
                            } else {
                                echo $arr['staff_note'];
                            } ?>
                        ...
                        <td>
                            <a href="ren-staff-edit.php?id=<?php echo $arr['staff_id'] ?>">修改</a> |
                            <a href="#" onClick="delstaffGo(<?php echo $arr['staff_id'] ?>)">删除</a>
                        </td>
                    </tr>
            ...
            //第一页
            echo "<a href='ren-staff.php?page=1'>" . '第一页' . "</a> ";

            //循环输出中间的页
            for ($i = 1; $i <= $totalPages; $i++) {
                echo "<a href='ren-staff.php?page=" . $i . "'> &nbsp;" . $i . "&nbsp; </a> ";
            };

            //最后一页
            echo "<a href='ren-staff.php?page=$totalPages'>" . '最后一页' . "</a> ";
