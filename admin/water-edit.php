...
<div class="con">
    ...
    <div class="right">
        ...
        <center>
            ...
            <table width="1050" border="1" align="center" rules="all" cellpadding="5">
                ...
                foreach ($arrs as $arr) { ?>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <a href="water-edit-go.php?id=<?php echo $arr['water_id'] ?>">修改</a>
                        </td>
                    </tr>
            ...
            //第一页
            echo "<a href='water-edit.php?page=1'>" . '第一页' . "</a> ";

            //循环输出中间的页
            for ($i = 1; $i <= $totalPages; $i++) {
                echo "<a href='water-edit.php?page=" . $i . "'> &nbsp;" . $i . "&nbsp; </a> ";
            };

            //最后一页
            echo "<a href='water-edit.php?page=$totalPages'>" . '最后一页' . "</a> ";
