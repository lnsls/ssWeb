...
$staff_name = $arr['staff_name'];
$staff_pwd = $arr['staff_pwd'];
$staff_time = $arr['staff_time'];
$staff_phone = $arr['staff_phone'];
$staff_add = $arr['staff_add'];
$staff_note = $arr['staff_note'];
...
if (isset($_POST['token']) && $_POST['token'] == $_SESSION['token']) {
    ...
    //构建插入的SQL语句
    $sql = "UPDATE staff SET staff_name='$staff_name',staff_pwd='$staff_pwd',staff_time='$staff_time',staff_phone='$staff_phone',staff_add='$staff_add',staff_note='$staff_note' WHERE staff_id=$id";
            ...
            <form method="post" action="">
                ...
                <table width="600" bordercolor="#FFF" border="1" rules="all" align="center" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="staff_pwd" value="<?php echo $staff_pwd ?>"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="staff_time" value="<?php echo $staff_time ?>"></td>
                        <td width="120" align="right">手机号：</td>
                        <td><input type="text" name="staff_phone" value="<?php echo $staff_phone ?>"></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="staff_add" value="<?php echo $staff_add ?>"></td>
                        <td width="120" align="right">备注：</td>
                        <td><input type="text" name="staff_note" value="<?php echo $staff_note ?>""></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
