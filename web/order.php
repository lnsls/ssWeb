...
//获取总数量
$sql = "SELECT * FROM out_ WHERE client_id=$userId ORDER BY out_id DESC";
...
<div class="mianboy">
    ...
    <center>
        ...
        //根据搜索结果显示数据
        if ($totalRecords == 0) {
            echo "<br><br><br> <p class='wText'><font color=red> 一条订单都没有哇 >_< </font></p> <br><br><br>";
            require_once("../inc/footer.php");
            die();
        } else {
            echo "<p class='wText'>欢迎您再次光临噢 o_O </p><br><br><br>";
        }
        ?>
        ...
        //第一页
        echo "<a href='order.php?page=1'>" . '第一页' . "</a> ";
        ...
        //最后一页
        echo "<a href='order.php?page=$totalPages'>" . '最后一页' . "</a> ";
